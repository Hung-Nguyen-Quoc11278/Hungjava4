...
<nav class="navbar navbar-expand-lg" style="background-color:black;color:white">
	<div class="container-fluid">
		<a class="navbar-brand " style="color: white;"
			...
			<i style="font-size: 100px" class="fa fa-headphones mr-2" aria-hidden="true"></i>
			DuTúB
		</a>
				...
				<c:choose>
					<c:when test="${not empty sessionScope.currentUser}">
						...
						<c:if test = "${sessionScope.currentUser.getIsAdmin() == true}">
							<li class="nav-item"><a class="nav-link nav-link-1"
								href="http://localhost:8080/ASM_FINAL_JV4/admin">Statistical</a></li>
						</c:if>
						<li class="nav-item"><a class="nav-link nav-link-1"
...
<div class="tm-hero d-flex justify-content-center align-items-center"
	...
	data-image-src="<c:url value='/Template/User/img/download.jpg'/>">
</div>
<!-- Modal -->
<div class="modal fade" id="changePassModal" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<h5 style="color:white" class="text-center" id="messageChangePass"></h5>
