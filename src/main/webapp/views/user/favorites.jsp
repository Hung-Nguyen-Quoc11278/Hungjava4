...
<title>Yêu Thích - Web của Tới</title>
...
<body>
	...
	<div class="container-fluid tm-container-content tm-mt-60">
		<div class="row mb-4">
			<h2 class="col-12 tm-text-primary text-center">Danh sách yêu thích</h2>
		</div>
						...
						<img src="<c:url value='${video.poster}'/>" alt="Image"
							class="img-fluid">
												<figcaption
													...
													<a href="<c:url value='/video?action=watch&id=${video.href}'/>">Xem Thêm</a>
												</figcaption>
					</figure>
